									...
									<c:forEach items="${permissionList}" var="p">
										<tr>
											...
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/permission/findById.do?peid=${p.peid}" class="btn bg-olive btn-xs">详情</a>
												<a href="${pageContext.request.contextPath}/permission/deletePermission.do?peid=${p.peid}" class="btn bg-olive btn-xs">删除权限</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
